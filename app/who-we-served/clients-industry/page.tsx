...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.keytegroup.com/who-we-served/clients-industry/'
  }
}
...
export default function Page() {
  return (
    <SubpageLayout>
      <Script
        id="clients-industry-structured-data"
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              'Comprehensive list of clients served across diverse industries including healthcare, manufacturing, financial services, and administration',
            url: 'https://www.keytegroup.com/who-we-served/clients-industry/',
            mainEntity: {
              '@type': 'Organization',
              name: 'Keyte Group',
              hasCredential: [
                {
                  ...
                  credentialCategory: 'Healthcare Industry Experience',
                  recognizedBy: {
                    '@type': 'Organization',
                ...
                {
                  '@type': 'EducationalOccupationalCredential',
                  credentialCategory: 'Manufacturing Industry Experience',
                  recognizedBy: {
                    '@type': 'Organization',
                ...
                {
                  '@type': 'EducationalOccupationalCredential',
                  credentialCategory: 'Financial Services Experience',
                  recognizedBy: {
                    '@type': 'Organization',
                ...
                {
                  '@type': 'EducationalOccupationalCredential',
                  credentialCategory: 'Administration Experience',
                  recognizedBy: {
                    '@type': 'Organization',
                    name: 'Administration Industry'
                  }
                }
              ]
            }
              ...
              <div className="foundation-row">
                <div className="three columns hide-for-small">
                  <ul className="side-nav">
                    ...
                    <li className="active">
                      <a href="clients-industry" target="_self" className="">
                        Clients By Industry
                      </a>
                    </li>
                  </ul>
                  ...
                  <p>
                    <em>
                      Cross-industry experience brings fresh perspectives to
                      every engagement
                    </em>
                  </p>
                </div>
                ...
                <div className="nine columns">
                  <ul className="breadcrumbs">
                    ...
                    <li>
                      <a href="#">Clients by Industry</a>
                    </li>
                  </ul>
                  <h1>Clients by Industry</h1>

                  <p>
                    Over the years, Keyte Group worked with organizations across
                    a wide range of industries, helping them implement lean
                    principles and achieve operational excellence. Our
                    experience spans both manufacturing and service sectors,
                    demonstrating the universal applicability of lean thinking.
                  </p>
                  ...
                  <p>
                    Regardless of industry, the fundamental principles of lean
                    thinking applied universally. Our approach focused on:
                  </p>

                  <ul>
                    <li>
                      <strong>Value Stream Mapping</strong> - Understanding how
                      work flows through any organization
                    </li>
                    <li>
                      <strong>Waste Elimination</strong> - Identifying and
                      removing non-value-added activities
                    </li>
                    <li>
                      <strong>Continuous Improvement</strong> - Building
                      capability for ongoing problem-solving
                    </li>
                    <li>
                      <strong>Leadership Development</strong> - Developing
                      leaders who could sustain improvements
                    </li>
                  </ul>

                  <p>
                    Each industry brought unique challenges and opportunities,
                    but the core methodology remained consistent: engage people
                    in improving their own work processes, eliminate waste, and
                    create flow.
                  </p>
                  ...
                  <p>
                    Working across industries provided valuable insights into
                    how lean principles adapted to different environments:
                  </p>

                  <ul>
                    <li>
                      <strong>Manufacturing</strong> - Focus on physical flow,
                      inventory reduction, and production efficiency
                    </li>
                    <li>
                      <strong>Healthcare</strong> - Emphasis on patient flow,
                      safety, and care quality
                    </li>
                    <li>
                      <strong>Financial Services</strong> - Streamlining
                      information flow and reducing processing time
                    </li>
                    <li>
                      <strong>Government</strong> - Improving citizen services
                      and regulatory processes
                    </li>
                  </ul>

                  <p>
                    This cross-pollination of ideas often led to breakthrough
                    innovations as concepts from one industry proved valuable in
                    another.
                  </p>
                  ...
                  <div className="testimonial">
                    ...
                    <blockquote>
                      <p>
                        "What impressed us most about Keyte Group was their
                        ability to understand our industry-specific challenges
                        while applying proven lean principles. They didn't just
                        bring a cookie-cutter approach - they adapted their
                        methods to our unique environment."{' '}
                        <cite>Manufacturing Client</cite>
                      </p>
                    </blockquote>
                  </div>
                </div>
