      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              'Comprehensive portfolio of clients served across diverse industries including manufacturing, healthcare, and service sectors',
            url: 'https://www.keytegroup.com/who-we-served/',
            mainEntity: {
              '@type': 'Organization',
              name: 'Keyte Group',
              ...
              <div className="foundation-row">
                <div className="three columns hide-for-small">
                  ...
                  <img
                    ...
                    alt="Solutions Lie Outside The Comfort Zone"
                    src="/images/detour-sign.jpg"
                    width="210"
                    height="225"
                  />
                  <p>
                    <i>We help you respond nimbly to change.</i>
                  </p>
                </div>
                ...
                <div className="nine columns">
                  <ul className="breadcrumbs">
                    ...
                    <li>
                      <a href="#">Who We Have Served</a>
                    </li>
                  </ul>
                  <h1>Who We Have Served</h1>
                  <h3>Guiding Organizational Transformation</h3>
                  <p>
                    Organizations across various sectors benefit from analytical
                    approaches, training, facilitation, and leadership coaching.
                    Lean strategies and techniques can improve work processes in
                    environments ranging from healthcare to financial services,
                    manufacturing, and general office settings.
                  </p>

                  <h4>How Organizations Benefit</h4>
                  <ul>
                    <li>
                      We stimulate new thinking about how to align workflow with
                      performance goals.
                    </li>
                    <li>We mobilize and guide systemic learning.</li>
                    <li>
                      We support executive leaders and line managers as they
                      enable their organizations to adapt and innovate.
                    </li>
                  </ul>

                  <h4>Client Examples</h4>
                  <p>
                    Many organizations across diverse industries have benefited
                    from these strategies, including{' '}
                    <strong>Hadassah Hospital</strong> (Israel),{' '}
                    <strong>Mayo Clinic</strong>,{' '}
                    <strong>Michigan Hospital Association</strong>,{' '}
                    <strong>Levi Strauss</strong>, <strong>Red Gold</strong>,{' '}
                    <strong>Capital One</strong>, <strong>Wells Fargo</strong>,{' '}
                    <strong>Bosch</strong>, <strong>Medtronics</strong>, and{' '}
                    <strong>Pfizer</strong>.
                  </p>
                  <p>
                    For a complete list of clients by industry,{' '}
                    <a title="Clients By Industry" href="clients-industry/">
                      click here
                    </a>
                    .
                  </p>
                  ...
                  <div className="testimonial">
                    <h3>Testimonial</h3>
                    <blockquote>
                      "We were always struggling to find times to do things. The
                      sheer amount of STUFF that occurs: ordering prescription
                      refills, physical therapy, etc. Now we go about our daily
                      tasks in a more organized fashion and are able to focus on
                      true headaches, problems, and recurring issues. As a
                      result, we are able to do more good things for our
                      patients and ourselves."{' '}
                      <cite> Office manager, large physician practice</cite>
                    </blockquote>
                  </div>
                </div>
              </div>
